          ...
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 margin-top-10 ">
				<div class="col-lg-12 col-md-12 col-sm-12 margin-top-10 ">
				  <h2 style="font-family:Roboto; font-size:80px">Register into the thinking<br>network</h2>
				</div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-5 pull-right  " style="font-family:Lato; font-wait:100">
              <div class="form-info">
			  <p style="font-family:Roboto; font-color:#gray; font-size:15px; padding-bottom:10px"> Register </P>
			    <div class="content-form-page">
                  <form class="form-horizontal form-without-legend" role="form">
                    <div class="form-group"> <label for="myaccountnumber" class="col-lg-12 control-label"> <span class="require"></span></label>
                      <div class="col-lg-12">
                        <input type="text" class="form-control" style=" font-size:11px; font-style:italic" id="myaccountnumber" placeholder="My Account Number "> 
